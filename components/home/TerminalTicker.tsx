...
export function TerminalTicker({ label, symbol, data, isLoading }: TerminalTickerProps) {
  ...
  return (
    <div
      className="min-w-[285px] shrink-0 rounded border border-border bg-card/95 px-2.5 py-2 shadow-sm"
    >
      <div className="mb-2 border-b border-border pb-2">
        <div className="mb-1.5 flex items-center justify-between gap-2">
          ...
          <span className="truncate font-mono text-[10px] text-muted-foreground">{label}</span>
        </div>
      ...
      {isLoading ? (
        <div className="space-y-1.5 pb-0.5">
          <div className="grid grid-cols-[1fr,72px,72px] gap-2 border-b border-border pb-1 font-mono text-[10px] uppercase tracking-wide text-muted-foreground/70">
            <span>Name</span>
